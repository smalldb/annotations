...
EOT
    ...
    public function testAnnotationEnumeratorException()
    {
        ...
        try {
            ...
            self::assertEquals('[Enum Error] Attribute "value" of @Smalldb\Annotations\Tests\Fixtures\AnnotationEnum declared on property Smalldb\Annotations\Tests\Fixtures\ClassWithAnnotationEnum::$invalidProperty accept only [ONE, TWO, THREE], but got FOUR.', $exc->getMessage());
        }
        ...
        try {
            ...
            self::assertEquals('[Enum Error] Attribute "value" of @Smalldb\Annotations\Tests\Fixtures\AnnotationEnum declared on method Smalldb\Annotations\Tests\Fixtures\ClassWithAnnotationEnum::invalidMethod() accept only [ONE, TWO, THREE], but got 5.', $exc->getMessage());
        }
    }
...
{
    /**
     * @\Smalldb\Annotations\Tests\Foo\Name(name = "foo")
     */
    protected $child;
}
...
{
    /**
     * @\Smalldb\Annotations\Tests\Bar\Name(name = "bar")
     */
    private $parent;
}
...
namespace Smalldb\Annotations\Tests\Foo;
