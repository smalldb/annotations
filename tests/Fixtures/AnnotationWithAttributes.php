 ...
 * @Attributes({
      ...
      @Attribute("annotation",           type = "Smalldb\Annotations\Tests\Fixtures\AnnotationTargetAll"),
      @Attribute("arrayOfAnnotations",   type = "array<Smalldb\Annotations\Tests\Fixtures\AnnotationTargetAll>"),
  })
 */
final class AnnotationWithAttributes
{
    ...
    /**
     * @return \Smalldb\Annotations\Tests\Fixtures\AnnotationTargetAll
     */
