...
class DocLexerTest extends TestCase
{
    ...
    {
        $lexer      = new DocLexer();
        $docblock   = '@AnnotationWithConstants(PHP_EOL, ClassWithConstants::SOME_VALUE, ClassWithConstants::CONSTANT_, ClassWithConstants::CONST_ANT3, \Smalldb\Annotations\Tests\Fixtures\InterfaceWithConstants::SOME_VALUE)';
        ...
        $tokens = [
            ...
            [
                'value'     => '\\Smalldb\\Annotations\\Tests\\Fixtures\\InterfaceWithConstants::SOME_VALUE',
                'position'  => 129,
                'type'      => DocLexer::T_IDENTIFIER,
            ],
            [
